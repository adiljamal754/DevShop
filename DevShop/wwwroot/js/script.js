...
const closeCart = document.querySelector(".bx");
...
function addEvents() {
    ...
    // Add item to cart 
    let addCart_btns = document.querySelectorAll(".btn-add");
...
function handle_addCartItem() {
    ...
    //let productImage = prod.parentElement;  
    

    let title = product.querySelector(".category-child").innerHTML;
    let price = product.querySelector(".price-child").innerHTML;
